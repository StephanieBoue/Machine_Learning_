...
```
The out of sample error ranges between XX for lda and XX for random forest.
...
test_pred_comb<-predict(combModFit, testing,type="prob")

preds<-test_pred_rpart*test_pred_lda*test_pred_gbm*test_pred_rf)
preds
```
