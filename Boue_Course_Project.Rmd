...
```
The out of sample error ranges between XX for lda and XX for random forrest.
...
preds<-round(test_pred_rpart*accuracy_rpart+test_pred_lda*accuracy_lda+test_pred_gbm*accuracy_gbm+test_pred_rf*accuracy_rf,2)
preds
```
